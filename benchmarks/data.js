    ...
    "n8n-mcp Benchmarks": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "973a4e8ba614c8dae4ac5b35ee3c3262613237fa",
          "message": "feat: Chatwoot integration + Docker CI for GHCR (#1)\n\n* feat: add Chatwoot integration module\n\nAdd integration for @renatoascencio/n8n-nodes-chatwoot community node:\n- 5 workflow templates (monitoring, contact sync, messaging, automation, public API)\n- Connection validator for Application and Platform APIs\n- Installation guide generator\n- Capabilities summary for AI agents\n- Template discovery by category and difficulty\n\nCo-Authored-By: Claude Opus 4.5 <noreply@anthropic.com>\n\n* feat(docker): update Dockerfile labels for fork\n\nPoint OCI image.source label to RenatoAscencio/n8n-mcp and update\ndescription to mention Chatwoot integration.\n\nCo-Authored-By: Claude Opus 4.5 <noreply@anthropic.com>\n\n* ci: publish docker image to GHCR on push and tags\n\nAdd docker-publish.yml workflow that builds and pushes to\nghcr.io/renatoascencio/n8n-mcp on push to main and v* tags.\nTags: sha-short, semver (on tag), latest (on main).\n\nCo-Authored-By: Claude Opus 4.5 <noreply@anthropic.com>\n\n* docs: document Chatwoot integration and container usage\n\nAdd fork-specific section to README with Docker run commands\nfor stdio/HTTP modes and table of included workflow templates.\n\nCo-Authored-By: Claude Opus 4.5 <noreply@anthropic.com>\n\n---------\n\nCo-authored-by: Claude Opus 4.5 <noreply@anthropic.com>",
          "timestamp": "2026-02-04T18:53:37-07:00",
          "tree_id": "47830aada68ef36ae6a5bf90809c4b08c32c4aa8",
          "url": "https://github.com/RenatoAscencio/n8n-mcp/commit/973a4e8ba614c8dae4ac5b35ee3c3262613237fa"
        },
        "date": 1770256550718,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "b30918db63d4bf263030ae78f98792c7c68aeac1",
          "message": "ci: add multi-arch support (amd64 + arm64) to docker-publish\n\nAdd QEMU and platforms: linux/amd64,linux/arm64 so the image\nworks natively on both x86 servers and Apple Silicon / ARM hosts.\n\nCo-Authored-By: Claude Opus 4.5 <noreply@anthropic.com>",
          "timestamp": "2026-02-04T19:57:53-06:00",
          "tree_id": "06c2f5cb5e09e657145bd919cca4aa3eabeadc14",
          "url": "https://github.com/RenatoAscencio/n8n-mcp/commit/b30918db63d4bf263030ae78f98792c7c68aeac1"
        },
        "date": 1770256790951,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "eb2f8b459c3391f94cfa12fb9fd0989f3959f4b2",
          "message": "docs(chatwoot): add Claude Desktop config and troubleshooting to README\n\nAdd Claude Desktop configuration section with JSON example and\nplatform-specific config paths. Add troubleshooting table covering\n6 common issues: JSON errors, missing env vars, missing credentials,\nconnection refused, auth failures, and missing templates.\n\nCo-Authored-By: Claude Opus 4.5 <noreply@anthropic.com>",
          "timestamp": "2026-02-04T20:26:27-06:00",
          "tree_id": "85bcb04c0ede31e28f3bf79fa3828c43b8f1c03c",
          "url": "https://github.com/RenatoAscencio/n8n-mcp/commit/eb2f8b459c3391f94cfa12fb9fd0989f3959f4b2"
        },
        "date": 1770259170097,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "db09e781bb20960bf11eb7098a763ad40cdde0c6",
          "message": "docs(chatwoot): add Claude Desktop config and troubleshooting to README\n\nAdd Claude Desktop configuration section with JSON example and\nplatform-specific config paths. Add troubleshooting table covering\n6 common issues: JSON errors, missing env vars, missing credentials,\nconnection refused, auth failures, and missing templates.\n\nCo-Authored-By: Claude Opus 4.5 <noreply@anthropic.com>",
          "timestamp": "2026-02-13T18:20:29-06:00",
          "tree_id": "d1ee6ee92113af4bacb5e6b4fd794125b1173ed4",
          "url": "https://github.com/RenatoAscencio/n8n-mcp/commit/db09e781bb20960bf11eb7098a763ad40cdde0c6"
        },
        "date": 1771030801057,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "b5fb4ae1325b8b9638f05b13f8cff6421a78f93f",
          "message": "feat: TVPlus MCP operator kit (compose, rules, smoke tests)\n\n- docker-compose.tvplus.yml: HTTP mode for Docker Desktop\n- .env.tvplus.example: placeholder env file (no secrets)\n- MCP_SMOKE.md: evidence of Chatwoot node detection (27 resources, 130+ ops)\n- WORKFLOW_BUILDER_RULES.md: MCP-first workflow construction rules\n- workflows/smoke-test-chatwoot-list.json: minimal Chatwoot smoke workflow\n- N8N_WORKFLOW_SMOKE.md: creation/validation evidence (ID: xOKKnZUqk4Gsh93z)\n- .gitignore: added .env.tvplus\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-02-14T13:57:07-06:00",
          "tree_id": "4f80db84bfb8bcb69ac4bd7822448635c3c38cbb",
          "url": "https://github.com/RenatoAscencio/n8n-mcp/commit/b5fb4ae1325b8b9638f05b13f8cff6421a78f93f"
        },
        "date": 1771099171218,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "35294e12a66efa68615f23201cf23b5f6020f8ea",
          "message": "feat(chatwoot): register Chatwoot nodes in MCP catalog + graceful validator degradation\n\n- Add static catalog definitions for both Chatwoot community nodes (main + trigger)\n  so they appear in search_nodes and pass workflow validation\n- Modify workflow validator to emit warnings (not errors) for unknown community nodes,\n  keeping result.valid=true while still flagging them for user awareness\n- Register Chatwoot nodes during database rebuild via dynamic import\n- Add 11 tests covering catalog definitions and community node validation behavior\n\nConcieved by Romuald Członkowski - www.aiadvisors.pl/en\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-02-15T00:55:56-06:00",
          "tree_id": "4da21f32eeff7b2778d57929d84649c297d1b29a",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "c705ce83ade777c189ce17ab0b79702aeb43c01a",
          "message": "ci: replace npm ci with npm install for cross-version compatibility\n\nnpm ci fails when package-lock.json is generated with npm 11 (Node 25)\nbut CI runs npm 10 (Node 22) due to transitive dependency resolution\ndifferences. Using npm install avoids this strict lockfile check.\n\nConcieved by Romuald Członkowski - www.aiadvisors.pl/en\n\nCo-Authored-By: Claude Opus 4.6 (1M context) <noreply@anthropic.com>",
          "timestamp": "2026-03-24T20:37:46-06:00",
          "tree_id": "90de2370a154c64022bb46a32fee7caa485c9b61",
          "url": "https://github.com/RenatoAscencio/n8n-mcp/commit/c705ce83ade777c189ce17ab0b79702aeb43c01a"
        },
        "date": 1774406526153,
        "tool": "customSmallerIsBetter",
        "benches": [
